OVN_FIMIR_RUINS_REVEAL = OVN_FIMIR_RUINS_REVEAL or {}
local mod = OVN_FIMIR_RUINS_REVEAL

local function add_on_first_tick()
	core:remove_listener("ovn_fimir_cache_char_cqi_for_ruins_reveal")
	core:add_listener(
		"ovn_fimir_cache_char_cqi_for_ruins_reveal",
		"CharacterSelected",
		true,
		function(context)
			---@type CA_CHAR
	...
	core:remove_listener("ovn_fimir_ruins_reveal_overwrite_popup_cb")
	core:add_listener(
			"ovn_fimir_ruins_reveal_overwrite_popup_cb",
			"RealTimeTrigger",
			function(context)
					return context.string == "ovn_fimir_ruins_reveal_overwrite_popup"
			end,
			function()
	...
	real_timer.unregister("ovn_fimir_ruins_reveal_overwrite_popup")
	real_timer.register_repeating("ovn_fimir_ruins_reveal_overwrite_popup", 0)
end

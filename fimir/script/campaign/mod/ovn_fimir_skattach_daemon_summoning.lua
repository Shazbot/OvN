...
local function ovn_fimir_skattach_daemons()
	...
	if cm:get_saved_value("ovn_fimir_skattach_daemons_enable") == nil then
		...
		local cror_list = {
            ...
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_sla_mon_soul_grinder_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 2, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_sla_mon_soul_grinder_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_kho_mon_soul_grinder_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 2, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_kho_mon_soul_grinder_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_nur_mon_soul_grinder_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 2, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_nur_mon_soul_grinder_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_tze_mon_soul_grinder_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 2, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_tze_mon_soul_grinder_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_kho_veh_skullcannon_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 4, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_kho_veh_skullcannon_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_sla_mon_fiends_of_slaanesh_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 4, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_sla_mon_fiends_of_slaanesh_0_warriors_faction_pool"},
            {faction_key = "ovn_fim_rancor_hold", unit = "wh3_main_sla_veh_seeker_chariot_0", rsrc = "daemonic_summoning", count = 0, rcp = 0, munits = 4, murpt = 0, frr = "", srr = "", trr = "", replen = true, mgroup = "wh3_main_sla_veh_seeker_chariot_0_warriors_faction_pool"},

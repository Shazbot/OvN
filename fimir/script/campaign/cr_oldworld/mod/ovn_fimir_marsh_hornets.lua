local function spawn_new_force()
	cm:create_force_with_general(
		...
		"cr_oldworld_region_floating_village", -- region_key,
		870, -- x,
		446, -- y,
		"general", -- type,
...
local function new_game_startup()
    ...
    local cr_floating_village = cm:get_region("cr_oldworld_region_floating_village")
    cm:transfer_region_to_faction("cr_oldworld_region_floating_village", "ovn_fim_marsh_hornets")
	cm:instantly_set_settlement_primary_slot_level(cr_floating_village:settlement(), 3)
	cm:instantly_upgrade_building_in_region(cr_floating_village:slot_list():item_at(2), "ovn_fimir_infantry_1")
	
	cm:heal_garrison(cr_floating_village:cqi());

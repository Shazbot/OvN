...
local function new_game_startup()
	...
	cm:override_building_chain_display("wh_main_VAMPIRES_settlement_major", "ovn_arb_special_settlement_al_haikk", "wh3_main_combi_region_al_haikk")
    ...
    if sultanate_of_all_araby:is_human() then
          cm:create_force_with_general(
            ...
            "wh_dlc07_brt_cav_questing_knights_0,wh_main_brt_inf_peasant_bowmen,wh_main_brt_inf_peasant_bowmen,wh_main_brt_inf_men_at_arms,wh_dlc07_brt_peasant_mob_0",
        ...
        cm:force_declare_war("wh2_main_brt_thegans_crusaders", "ovn_arb_sultanate_of_all_araby", false, false)

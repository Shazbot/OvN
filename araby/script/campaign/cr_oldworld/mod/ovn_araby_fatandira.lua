local function spawn_new_force()
	cm:create_force_with_general(
		...
		"cr_oldworld_region_vitrolle", -- region_key,
		1083, -- x,
		851, -- y,
		"general", -- type,
...
local function new_game_startup()
    ...
    -- replace campaign settlement visuals
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_major", "ovn_arb_special_settlement_al_haikk", "cr_oldworld_region_al_haikk")
    cm:override_building_chain_display("wh3_main_ogr_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_bakr_oasis")
    cm:override_building_chain_display("wh3_main_ogr_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_asad_oasis")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_major", "ovn_arb_settlement_major", "cr_oldworld_region_arjijil")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_hashishins_lair")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_fyrus")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_major", "ovn_arb_settlement_major", "cr_oldworld_region_el_khabbath")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_oasis_of_gazi")
    cm:override_building_chain_display("wh3_main_ogr_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_muzil_oasis")
    cm:override_building_chain_display("wh3_main_ogr_settlement_major", "ovn_arb_settlement_major", "cr_oldworld_region_malaluk_oasis")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_gobi_alain")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_djambiya")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_major", "ovn_arb_settlement_major", "cr_oldworld_region_teshert")
    cm:override_building_chain_display("wh_main_BRETONNIA_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_salt_plain")
    cm:override_building_chain_display("wh_main_EMPIRE_settlement_major", "ovn_arb_settlement_major", "cr_oldworld_region_vitrolle")
	
    local target_region = cm:get_region("cr_oldworld_region_vitrolle")
    cm:transfer_region_to_faction("cr_oldworld_region_vitrolle", "ovn_arb_aswad_scythans")

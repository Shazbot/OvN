local function spawn_new_force()
	cm:create_force_with_general(
		...
		"cr_oldworld_region_el_khabbath", -- region_key,
		231, -- x,
		410, -- y,
		"general", -- type,
...
local function new_game_startup()
	...
	cm:override_building_chain_display("wh2_main_lzd_settlement_minor", "ovn_arb_settlement_minor", "cr_oldworld_region_el_khabbath")
	
    local the_copper_landing = cm:get_region("cr_oldworld_region_el_khabbath")
    cm:transfer_region_to_faction("cr_oldworld_region_el_khabbath", "ovn_arb_golden_fleet")

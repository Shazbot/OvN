...
local function new_game_startup()
    ...
    cm:make_region_visible_in_shroud("wh2_main_hef_citadel_of_dusk", "wh3_main_combi_region_lothern")
            
        --Spawn Starting Enemy Army
        
            if citadel_of_dusk:is_human() then

        cm:create_force_with_general(
				"wh2_main_def_dark_elves_qb1",
                "wh2_main_def_inf_black_ark_corsairs_0,wh2_main_def_inf_black_ark_corsairs_1,wh2_main_def_cav_cold_one_knights_0",
		...
		cm:force_declare_war("wh2_main_def_dark_elves_qb1", "wh2_main_hef_citadel_of_dusk", false, false)
		cm:change_custom_faction_name("wh2_main_def_dark_elves_qb1", "Megara's Corsairs")
